...
import com.pragma.traceabilityservice.infrastructure.constants.InfrastructureConstants;
import com.pragma.traceabilityservice.infrastructure.output.security.adapter.JwtServiceAdapter;
...
public class CustomAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void setResponseProperties(HttpServletResponse response, int status,
        ...
        payload.put(InfrastructureConstants.KEY_PATH,
                request != null ? request.getRequestURI() : InfrastructureConstants.EMPTY_STRING);
